/****************************************************************************
** Meta object code from reading C++ file 'thewidget.h'
**
...
#include "../../dinosaur_running/thewidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'thewidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TheWidget_t, stringdata) + ofs \
...
const QMetaObject TheWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TheWidget.data,
      qt_meta_data_TheWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TheWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TheWidget.stringdata))
